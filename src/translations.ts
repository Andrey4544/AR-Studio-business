...
export const dynamicTranslations = {
  en: {
    ...
    featuredProjects: [
      ...
      {
        id: 'enframe-speed-optimization',
        title: 'Enframe.bg',
        category: 'Website Speed Optimisation',
        url: 'https://enframe.bg/',
        imageUrl: 'enframe_speed_optimization_mockup',
        videoUrl: '/assets/enframe-speed-optimization.mp4',
        highlights: [
          'Existing-site optimisation - Focused performance improvements without rebuilding the website',
          'Network snapshot - 62 requests, 1.2 MB transferred and 3.0 MB resources',
          'Timing snapshot - 752 ms Finish and 587 ms DOMContentLoaded',
          'Multi-page validation - Home, portfolio, photography, video, packages, about and contact',
          'Recorded proof - Real navigation across the live website',
        ],
        description: 'A measured speed optimisation project for the existing Enframe.bg wedding photography and videography website. We focused on loading performance and verified the live experience across its key pages without turning the work into a new website build.',
        businessProblem: 'The existing website needed to feel faster and more responsive for couples browsing galleries, packages and contact information across multiple pages. The work focused on practical performance improvements and validation rather than blind changes.',
        tags: ['Speed Optimisation', 'Performance', 'Core Web Vitals', 'Existing Website'],
      },
      {
        id: 'teddys-bar-grill',
  ...
  bg: {
    ...
    featuredProjects: [
      ...
      },
      {
        id: 'enframe-speed-optimization',
        title: 'Enframe.bg',
        category: 'Оптимизация на скоростта на уебсайт',
        url: 'https://enframe.bg/',
        imageUrl: 'enframe_speed_optimization_mockup',
        videoUrl: '/assets/enframe-speed-optimization.mp4',
        highlights: [
          'Оптимизация на съществуващ сайт - Фокусирани подобрения без изграждане на нов уебсайт',
          'Мрежово измерване - 62 заявки, 1.2 MB трансферирани и 3.0 MB ресурси',
          'Време на зареждане - Finish 752 ms и DOMContentLoaded 587 ms',
          'Проверка на няколко страници - Начална, портфолио, фотография, видео, пакети, за нас и контакти',
          'Видео доказателство - Реална навигация в публикувания уебсайт',
        ],
        description: 'Измерена оптимизация на скоростта на съществуващия сайт Enframe.bg за сватбена фотография и видеозаснемане. Фокусирахме се върху зареждането и проверихме реалното изживяване през основните страници, без да изграждаме сайта наново.',
        businessProblem: 'Съществуващият сайт трябваше да бъде по-бърз и по-отзивчив за двойки, които разглеждат галерии, пакети и контакти на няколко страници. Работата беше насочена към практични подобрения и измерване, а не към промени на сляпо.',
        tags: ['Оптимизация на скоростта', 'Производителност', 'Core Web Vitals', 'Съществуващ сайт'],
      },
      {
        id: 'teddys-bar-grill',
        title: 'Teddy\'s Bar & Grill',
