          ...
          <div className="p-8 rounded-2xl bg-zinc-950/50 border border-white/5 inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-8 justify-between max-w-2xl mx-auto w-full">
            <div className="text-left">
              ...
              <p className="text-xs text-zinc-500">
                {language === 'en' 
                  ? 'Ask Andrey, Rumen & Nikolay directly. We deliver honest guidance and reply within 2–3 hours during the working day.'
                  : 'Задайте го на Андрей, Румен и Николай лично. Ще Ви отговорим откровено до 2–3 часа в рамките на работния ден.'}
              </p>
            </div>
