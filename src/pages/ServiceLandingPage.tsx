...
const englishServicePages: Record<keyof typeof servicePages, ServicePage> = {
  'website-plovdiv': {
    ...
    intro: 'We build websites that explain a business clearly, look professional on a phone, and guide visitors toward a useful next action: a call, enquiry, booking, or purchase.', price: 'From €249', priceNote: 'The final investment depends on the number of pages, available content, and required functionality.',
  ...
  'restaurant-website-plovdiv': {
    ...
    intro: 'When a guest searches for a restaurant, they want to quickly see the menu, atmosphere, address, and how to reserve. We organise those details so the website helps the venue instead of acting as a static brochure.', price: 'From €449', priceNote: 'QR menus and additional functionality are scoped around the menu size and preferred update process.',
  ...
  'beauty-salon-website-plovdiv': {
    ...
    intro: 'A salon website should show the result, atmosphere, and services before the first visit. We create a clear experience that makes booking easier and supports trust in the team.', price: 'From €449', priceNote: 'Online calendars, larger service menus, and multilingual content are scoped in the proposal.',
  ...
  'ecommerce-website-bulgaria': {
    ...
    intro: 'An online store should reduce doubt between the first visit and the order. We focus on clear categories, product pages, mobile checkout, and content that helps a customer decide.', price: 'From €599', priceNote: 'The exact price depends on product count, payments, delivery, integrations, and the chosen platform.',
